...
import com.imooc.dao.IOrderDetailDao;
import com.imooc.dao.IOrderMasterDao;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public OrderDTO create(OrderDTO orderDTO) {
        ...
        // 1.查询商品（获取价格）
        // 商品单价 不能从前端直接传过来 为了保证单价的正确性 应从数据库中获取
    ...
    public Page<OrderDTO> findList(String buyerOpenid, Pageable pageable) {
        Page<OrderMaster> orderMasterPage = iOrderMasterDao.findByBuyerOpenid(buyerOpenid, pageable);
    ...
    public Page<OrderDTO> findList(Pageable pageable) {
        Page<OrderMaster> orderMasterPage = iOrderMasterDao.findAll(pageable);
    ...
    public OrderDTO paid(OrderDTO orderDTO) {
        ...
        OrderMaster orderMaster = new OrderMaster();
        BeanUtils.copyProperties(orderDTO, orderMaster);
        OrderMaster updateResult = iOrderMasterDao.save(orderMaster);
